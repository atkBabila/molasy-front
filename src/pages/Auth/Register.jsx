                    ...
                    <div className="">
                        ...
                        <div className="w-full bg-gray-50 rounded-lg border text-gray-200 dark:bg-gray-700 dark:border-gray-600">
                            <div className="flex justify-between items-center py-2 px-3 border-b dark:border-gray-600">
                                ...
                                <button type="button" data-tooltip-target="tooltip-fullscreen" className="text-gray-500 p-2 rounded-md cursor-pointer sm:ms-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                            ...
                            <div className="py-2 px-4 bg-white rounded-b-lg ">
                                <textarea id="biography" rows="8" className="block px-0 w-full text-sm text-gray-800 bg-white border-0  dark:bg-gray-800 dark:text-white dark:placeholder-gray-400" placeholder="Write a message here" required=""></textarea>
                            </div>
                        </div>
                    </div>
                    <div className="">
                    ...
                    <div className=" ">
                        ...
                        <div className="flex ">
                            <div className="flex items-center mb-4">
                                <input id="inline-checkbox" type="checkbox" value="" name="role" className="w-4 h-4 text-blue-600 rounded-md border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                <label htmlFor="inline-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Administrator</label>
                            </div>
                            <div className="flex items-center mb-4">
                                <input id="inline-2-checkbox" type="checkbox" value="" name="role" className="w-4 h-4 text-blue-600 rounded-md border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                <label htmlFor="inline-2-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Member</label>
                            </div>
                            <div className="flex items-center mb-4">
                                <input id="inline-checked-checkbox" type="checkbox" value="" name="role" className="w-4 h-4 text-blue-600 rounded-md border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                <label htmlFor="inline-checked-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Viewer</label>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <label htmlFor="user-status" className="inline-flex relative items-center cursor-pointer">
                            <input type="checkbox" value="" id="user-status" className=" sr-only peer"/>
                            <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 dark:peer-focus:ring-blue-300 peer-focus:ring-blue-800 dark:bg-gray-700 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium p-2 dark:text-gray-300">Inactive</span>
                        </label>  
                    </div>
                </div>
